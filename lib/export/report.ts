...
export function toReport(session: Session): string {
  ...
  const title = escapeHtml(session.title || "Yenta session");

  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
<title>${title} — Yenta report</title>
...
<body>
<main>
  <div class="eyebrow"><span class="dot"></span>Yenta session report</div>
  <h1>${title}</h1>
  <div class="meta">
  ...
  <div class="footer">
    Generated by <a href="https://yenta.vercel.app/">Yenta</a>
  </div>
</main>
</body>
</html>`;
