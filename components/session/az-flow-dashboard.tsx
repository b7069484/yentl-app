...
const flowNodes: FlowNode[] = [
  ...
  },
  {
    ...
    branch: "Upload",
    screenshot: "/visual-evidence/flow-screenshots/current/audio-upload.png",
    sourcePath: "Target state missing: transcription/diarization progress.",
    screenshotStatus: "missing",
    screenshotNote: "Transcription and speaker detection need their own stage with partial transcript and failure states.",
  ...
  },
  {
    ...
    reviewAnchor: "Can a user fix diarization mistakes without breaking the record?",
  },
  {
    id: "document",
    title: "PDF / Text",
...
function getExtensionStage(id: string) {
  const baseSignals = [
    ...
    { label: "Rhetoric heat", value: "Rising", tone: "amber" as const },
  ...
  const variants: Record<string, Partial<ExtensionStageConfig>> = {
    "extension-install": {
      ...
      signals: [
        ...
        { label: "Rhetoric heat", value: "None yet", tone: "teal" },
    ...
    "extension-audio-meter": {
      ...
      signals: [
        ...
        { label: "Rhetoric heat", value: "Rising", tone: "amber" },
    ...
    "extension-no-audio": {
      ...
      signals: [
        ...
        { label: "Rhetoric heat", value: "Waiting", tone: "amber" },
