  ...
  return (
    <div className="max-w-[680px] mx-auto px-6 pt-8 pb-12">
      ...
      <div className="text-center py-12 text-ink-3">
        <div className="font-serif text-[22px] text-ink mb-2">Coming in T6</div>
        <div className="text-[13px]">Media URL ingest pane — implementation lands in the next task.</div>
      </div>
    </div>
  );
}
