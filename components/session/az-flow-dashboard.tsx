...
const flowNodes: FlowNode[] = [
  ...
  },
  {
    ...
    screenshotStatus: "reference",
    screenshotNote: "Same-page panel preview exists, with snapshot handoff implemented; still needs article, video, YouTube, and live sync variants.",
    missingStates: ["panel injected", "real article", "real video page", "YouTube page", "narrow panel"],
    x: 1420,
    y: 330,
  ...
  },
  {
    ...
    branch: "Extension",
    screenshot: "/visual-evidence/flow-screenshots/current/browser-sample.png",
    sourcePath: "components/session/extension-panel-view.tsx; components/session/home-overview.tsx; tests/extension-panel-view.test.tsx; tests/home-overview.test.tsx",
    screenshotStatus: "reference",
    screenshotNote: "The panel saves a snapshot before opening the full workspace, and the overview now renders extension source-continuity state. Future live sync remains a separate target.",
    missingStates: ["live sync connected", "source tab lost", "mobile handoff"],
    x: 2720,
    y: 520,
  ...
  },
  {
    ...
    branch: "Document",
    screenshot: "/visual-evidence/flow-screenshots/current/text-review.png",
    sourcePath: "components/session/ingest-panes/text-ingest-pane.tsx",
    screenshotStatus: "missing",
    screenshotNote: "PDF text-layer import is wired through the document pane with explicit scanned-PDF/OCR limits; page thumbnails and OCR progress remain future work.",
    missingStates: ["page thumbnails", "OCR progress", "OCR failed", "mobile PDF import screenshot"],
    x: 1160,
    y: 1580,
    children: ["pdf-ocr"],
